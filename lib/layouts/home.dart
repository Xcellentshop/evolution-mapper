            ...
            if (latestVersion != null && mounted)
              {
                showDialog(
                    ...
                    builder: (context) => AlertDialog(
                          ...
                          content: Text('${AppLocalizations.of(context)!.updateAvailable} $latestVersion. '
                          ...
                          actions: [
                            ...
                            TextButton(
                                ...
                                child: Text(AppLocalizations.of(context)!.ignoreThisVersion)),
                            ElevatedButton(
                ...
                children: [
                  TabBar(
                    ...
                    tabs: [
                      ...
                      Tab(icon: Icon(Icons.airplanemode_on), text: l10n.aircraft),
                      Tab(icon: Icon(Icons.photo_camera), text: l10n.camera),
                      Tab(icon: Icon(Icons.file_copy), text: l10n.file),
                    ],
                  ),
                  Expanded(
                      child: TabBarView(
